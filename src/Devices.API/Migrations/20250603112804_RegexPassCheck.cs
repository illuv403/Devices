...
{
    /// <inheritdoc />
    public partial class RegexPassCheck : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Account__536C85E474CA2AE2",
                table: "Account",
                column: "Username",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__DeviceTy__737584F6FB116A90",
                table: "DeviceType",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Person__45809E718A42E7AD",
                table: "Person",
                column: "PassportNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__85FB4E38DAB5C7D0",
                table: "Person",
                column: "PhoneNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__A9D105346305769B",
                table: "Person",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Position__737584F62B4A0C67",
                table: "Position",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Role__737584F65B7E46CE",
                table: "Role",
                column: "Name",
                unique: true);
        }
